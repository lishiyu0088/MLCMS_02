...
def file_df_to_count_df(df,
    ...
    for pid in pedestrian_ids:
        ...
        for (st, g) in simtime_group:
            ...
            ### New code implemented, if an infected state is removed, then the number of infection increases 1 and te number of recovery minus 1.###
...
def create_folder_data_scatter(folder):
    ...
    ### New code implemented: make a scatter plot for recovery state ###
